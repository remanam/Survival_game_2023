...
namespace SurvivalEngine
{
    ...
    public class ShopPanel : UISlotPanel
    {
        ...
        protected override void RefreshPanel()
        {
            ...
            {
                gold_value.text = current_player.Data.gold.ToString();
                ...
                if (select_item != null)
                {
                    ...
                    button.interactable = (sell && cost > 0 && CanSell(select_item)) || (!sell && cost <= current_player.Data.gold); 
                }
        ...
        public void OnClickBuy()
        {
            ...
            if (sell)
            {
                ...
                {
                    current_player.Data.gold += item.sell_cost;
            ...
            {
                if (current_player.Data.gold >= item.buy_cost)
                {
                    current_player.Data.gold -= item.buy_cost;
