...
namespace SurvivalEngine
{
    ...
    public class PlayerCharacterHoe : MonoBehaviour
    {
        ...
        {
            //Auto hoe
            Vector3 move_dir = character.GetAutoMoveTarget() - transform.position;
            if (character.IsAutoMove() && !character.IsDoingAction() && !character.Crafting.ClickedBuild() && move_dir.magnitude < hoe_range 
