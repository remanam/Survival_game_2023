...
namespace SurvivalEngine
{
    ...
    public class CraftData : IdData
    {
        ...
        public ItemData[] craft_items; //Items needed to craft this or to BUY this
        public GroupData[] craft_fillers; //Items needed to craft this (but that can be any item in group: any Vegetable)
